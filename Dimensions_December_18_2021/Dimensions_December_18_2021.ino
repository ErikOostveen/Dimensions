...
void drawCube() {
  ...
  delay(500);
    ...
    for( int pointShift = 0; pointShift < 20;  pointShift++ ) {
...
void CubeDef(int pointShift) {
  ...
  int p1x = xCube-aCube + pointShift;        int p1y = yCube-aCube;
  int p2x = xCube+aCube - pointShift;        int p2y = yCube-aCube;
  int p3x = xCube+aCube;        int p3y = yCube+aCube;
  int p4x = xCube-aCube;        int p4y = yCube+aCube;
  int p5x = xCube-aCube+bCube + pointShift;  int p5y = yCube-aCube-bCube;
  int p6x = xCube+aCube+bCube - pointShift;  int p6y = yCube-aCube-bCube;
  int p7x = xCube+aCube+bCube;  int p7y = yCube+aCube-bCube;
  int p8x = xCube-aCube+bCube;  int p8y = yCube+aCube-bCube;
